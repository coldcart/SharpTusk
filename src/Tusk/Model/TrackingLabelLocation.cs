...
namespace Tusk.Model
{
    ...
    public partial class TrackingLabelLocation : BaseModel
    {
        ...
        public TrackingLabelLocation(string city = default(string), string state = default(string), string postalCode = default(string))
        {
            this.City = city;
            this.State = state;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrackingLabelLocation {\n");
