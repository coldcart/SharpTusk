...
namespace Tusk.Client
{
    ...
    /// </summary>
    public class ReadableConfiguration : IReadableConfiguration
    {
        #region Constants
        ...
        public ReadableConfiguration()
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/1.0.0/csharp");
            BasePath = "https://apisandbox.tusklogistics.com";
        ...
        public ReadableConfiguration(
            ...
            string basePath = "https://apisandbox.tusklogistics.com") : this()
        {
        ...
        public ReadableConfiguration(TuskClientOptions options): this()
        {
            ...
            ApiKey.Add("x-api-key", options.ApiKey);
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/1.0.0/csharp");
            Timeout = 100000;
        }
        ...
        public static IReadableConfiguration MergeConfigurations(IReadableConfiguration first, IReadableConfiguration second)
        {
            ...
            var config = new ReadableConfiguration
            {
                ApiKey = apiKey,
